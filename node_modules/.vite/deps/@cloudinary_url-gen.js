import "./chunk-23IXBKBQ.js";
import "./chunk-YX2ZCHX2.js";
import "./chunk-3HKRX4FL.js";
import "./chunk-ZML2YF6N.js";
import "./chunk-QUXXBSOV.js";
import "./chunk-Q467YGXY.js";
import {
  Adjust,
  Animated,
  AnimatedFormat,
  ...
  Underlay,
  VideoEdit
} from "./chunk-FVO633OL.js";
import {
  Format
} from "./chunk-NDI4IUNI.js";
import {
  Overlay
...
import "./chunk-DOI2HF4F.js";
import "./chunk-M5SY7NK2.js";
import {
  Quality
} from "./chunk-Z3GCMYFP.js";
import {
  Source
} from "./chunk-R2IPGYCQ.js";
import "./chunk-B43TY7UJ.js";
import "./chunk-4UABOL5W.js";
import "./chunk-QVIFFLHX.js";
import {
  FontStyle,
  FontWeight,
  Stroke,
...
import "./chunk-UHKTWXPV.js";
import "./chunk-QESUYXYX.js";
import "./chunk-EVDDVMJB.js";
import {
  __export
...
var TextLayer = class extends layer_default2 {
   ...
   */
  toString() {
    var components, hasPublicId, hasStyle, publicId, re, res, start2, style, text, textSource;
    ...
    if (this.options.text != null) {
      ...
      while (res = re.exec(textSource)) {
        text += smartEscape2(textSource.slice(start2, res.index));
        text += res[0];
        start2 = res.index + res[0].length;
      }
      text += smartEscape2(textSource.slice(start2));
    }
    ...
    if (layer.resource_type === "fetch" || layer.url != null) {
      ...
      if ((!text || text.length === 0) && resource_type !== "text") {
        ...
        if (text && text.length >= 0) {
          ...
          text += encodeURIComponent(textSource.slice(start2));
        }
      }
...
function finalize_source2(source2, format, url_suffix) {
  let source_to_sign;
